...
public class EnglishPluralizer extends Pluralizer {
    ...
    private final Map<String, String> irregular;
    private final Map<String, Rule> suffixes;
    ...
    public EnglishPluralizer(Locale locale) {
        ...
        addIrregular(new String[]{
            "alumna", "alga", "vertebra", "larva",}, "a", "ae");
        ...
        if (classical)
            addIrregular(new String[]{
                "stamen", "foramen", "lumen",}, "en", "ina");

        addIrregular(new String[]{
            "bacterium", "agendum", "desideratum", "erratum",
            "stratum", "datum", "ovum", "extremum",
            "candelabrum", "forum",}, "um", "a");
        ...
        if (classical)
            addIrregular(new String[]{
                ...
                "torus", "umbilicus", "uterus",}, "us", "i");

        // Assimilated 4th declension Latin nouns
        if (classical)
            addIrregular(new String[]{
                "status", "apparatus", "prospectus", "sinus",
                "hiatus", "impetus", "plexus",}, "us", "us");

        addIrregular(new String[]{
            "criterion", "perihelion", "aphelion",
            "phenomenon", "prolegomenon", "noumenon",
            "organon", "asyndeton", "hyperbaton",}, "on", "a");
        ...
        addIrregular(new String[]{
            ...
            "stylo", "rhino", "piano",}, "o", "os");

        addIrregular(new String[]{
            "codex", "murex", "silex",}, "ex", "ices");

        if (classical)
            addIrregular(new String[]{
                "vortex", "vertex", "cortex", "latex",
                "pontifex", "apex", "index", "simplex",}, "ex", "ices");

        // Arabic
        if (classical)
            addIrregular(new String[]{
                "afrit", "afreet", "efreet",}, "", "i");

        // Hebrew
        if (classical)
            addIrregular(new String[]{
                "goy", "seraph", "cherub",}, "", "im");

        addIrregular(new String[]{
            "human", "Alabaman", "Bahaman", "Burman", "German",
            "Hiroshiman", "Liman", "Nakayaman", "Oklahoman",
            "Panaman", "Selman", "Sonaman", "Tacoman", "Yakiman",
            "Yokohaman", "Yuman",}, "man", "mans");
        ...
        addIrregular(new String[]{
            ...
            "sassafras", "tonsillitis", "trellis", /* ".*us", */}, "s", "ses");
        ...
        if (classical)
            addSuffix("trix", "trices", 80);
        if (classical)
            addSuffix("eau", "eaux", 80);
        if (classical)
            addSuffix("ieu", "ieux", 80);
    ...
    public String getPlural(String orig) {
        ...
        if (word.indexOf(' ') != -1) {
            ...
            if ((idx = word.indexOf(" of ")) != -1)
                return getPlural(word.substring(0, idx).trim())
                        + word.substring(idx);
